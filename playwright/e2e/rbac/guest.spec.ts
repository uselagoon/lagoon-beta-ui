...
test.describe('GUEST permission test suites', () => {
  test.beforeEach(async ({ page }) => {
    await loginUser(page, env.user_guest);
  });
  ...
  test.describe('Variables', () => {
    ...
    test('Fails to add a variable - no permission for GUEST', async ({ page }) => {
      await page.goto(`${env.url}/projects/lagoon-demo/project-variables`);
  ...
  test.describe('Environment overview', () => {
    ...
    test('Fails to delete PROD - no permission for GUEST', async ({ page }) => {
      await page.goto(`${env.url}/projects/lagoon-demo/lagoon-demo-main`);
      const interceptor = setupGraphQLInterception(page);
      interceptor.start();
      const environmentOverview = new EnvOverviewAction(page);
    ...
    test('Fails to delete any env - no permission for GUEST', async ({ page }) => {
  ...
  test.describe('Deployments', () => {
    test('Fails to do a PROD deployment - no permission for GUEST', async ({ page }) => {
    ...
    test('Fails to do a any deployment - no permission for GUEST', async ({ page }) => {
    ...
    test('Fails to do cancel a deployment - no permission for GUEST', async ({ page }) => {
      await page.goto(`${env.url}/projects/lagoon-demo/lagoon-demo-main/deployments`);
      await page.waitForLoadState('networkidle');
      const interceptor = setupGraphQLInterception(page);
      interceptor.start();
  ...
  test.describe('Deployment', () => {
    test('Fails to cancel deployment - no permission for GUEST', async ({ page }) => {
      await page.goto(`${env.url}/projects/lagoon-demo/lagoon-demo-main/deployments`);
      await page.waitForLoadState('networkidle');
      const interceptor = setupGraphQLInterception(page);
      interceptor.start();
  ...
  test.describe('Backups', () => {
    test('Fails to view backups - no permission to view for GUEST', async ({ page }) => {
  ...
  test.describe('Tasks', () => {
    test('Fails to cancel a running task - no permission for GUEST', async ({ page }) => {
    ...
    test('Fails to run DB backup task - no permission for GUEST', async ({ page }) => {
      await page.goto(`${env.url}/projects/lagoon-demo/lagoon-demo-main/tasks`);
      await page.waitForLoadState('networkidle');
      const interceptor = setupGraphQLInterception(page);
      interceptor.start();
    ...
    test('Fails to run DB/Files backup task - no permission for GUEST', async ({ page }) => {
      await page.goto(`${env.url}/projects/lagoon-demo/lagoon-demo-main/tasks`);
      await page.waitForLoadState('networkidle');
      const interceptor = setupGraphQLInterception(page);
      interceptor.start();
    ...
    test('Fails to generate login link - no permission for GUEST', async ({ page }) => {
      await page.goto(`${env.url}/projects/lagoon-demo/lagoon-demo-main/tasks`);
      await page.waitForLoadState('networkidle');
      const interceptor = setupGraphQLInterception(page);
      interceptor.start();
