...
export default function ProjectDetailsPage(props: ProjectDetailsProps) {
  ...
  if (project.organizationDetails) {
    detailItems.push({
      key: 'organization',
      title: 'ORGANIZATION',
      children: <span className="break-works text-lg">{project.organizationDetails.friendlyName || project.organizationDetails.name}</span>,
      lowercaseValue: true,
    })
  }
  ...
  return (
    <SectionWrapper>
      <ExtensionZoneRenderer zone="project-header" data={{
      ...
      <ExtensionZoneRenderer zone="project-footer" data={{
        projectName: project.name,
        gitUrl: project.gitUrl,
        created: project.created,
      }} />
