...
export default function ProjectDetailsPage(props: ProjectDetailsProps) {
  ...
  if (project.autogeneratedRoutes) {
    detailItems.push({
      key: 'autogeneratedRoutes',
      title: 'AUTOGENERATED ROUTES',
      children: <span className="break-words text-lg">{project.autogeneratedRoutes.toString()}</span>,
      lowercaseValue: true,
    })
  }
  if (project.autogeneratedRoutesPullrequests) {
    detailItems.push({
      key: 'autogeneratedRoutesPullrequests',
      title: 'AUTOGENERATED PULLREQUEST ROUTES',
      children: <span className="break-words text-lg">{project.autogeneratedRoutesPullrequests.toString()}</span>,
      lowercaseValue: true,
    })
  }
  if (project.autogeneratedRoutePrefixes) {
    detailItems.push({
      ...
      children: <span className="break-words text-lg">{project.autogeneratedRoutePrefixes.join(',')}</span>,
      lowercaseValue: true,
    })
  }
  ...
  //     children: <span className="break-words text-lg">{JSON.stringify(project.autogeneratedPathRoutes)}</span>,
  //     lowercaseValue: true,
  //   })
  // }
